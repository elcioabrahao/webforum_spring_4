...
import java.math.*;
 ...
 /**
  * Mensagem Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Mensagem object instances. 
  */
...
public class MensagemDao {
     ...
     * clone() method in it!
     */
    public Mensagem createValueObject() {
          return new Mensagem();
    }
     ...
     */
    public Mensagem getObject(Connection conn, int id) throws NotFoundException, SQLException {

          Mensagem valueObject = createValueObject();
     ...
     */
    public void load(Connection conn, Mensagem valueObject) throws NotFoundException, SQLException {

          String sql = "SELECT * FROM forum_mensagem WHERE (id = ? ) "; 
    ...
    public List loadAll(Connection conn) throws SQLException {
          ...
          String sql = "SELECT * FROM forum_mensagem ORDER BY id ASC ";
          List searchResults = listQuery(conn, conn.prepareStatement(sql));

          return searchResults;
    }

    public List loadAllFromId(Connection conn, int id) throws SQLException {
     ...
     */
    public synchronized void create(Connection conn, Mensagem valueObject) throws SQLException {
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void delete(Connection conn, Mensagem valueObject) 
          throws NotFoundException, SQLException {

          String sql = "DELETE FROM forum_mensagem WHERE (id = ? ) ";
          PreparedStatement stmt = null;
    ...
    public void deleteAll(Connection conn) throws SQLException {
          ...
          String sql = "DELETE FROM forum_mensagem";
          PreparedStatement stmt = null;
    ...
    public int countAll(Connection conn) throws SQLException {
          ...
          String sql = "SELECT count(*) FROM forum_mensagem";
          PreparedStatement stmt = null;
          ResultSet result = null;
          int allRows = 0;
     ...
     */
    public List searchMatching(Connection conn, Mensagem valueObject) throws SQLException {

          List searchResults;

          boolean first = true;
          StringBuffer sql = new StringBuffer("SELECT * FROM forum_mensagem WHERE 1=1 ");
          ...
          if (valueObject.getMensagem() != null) {
              if (first) { first = false; }
              sql.append("AND mensagem LIKE '").append(valueObject.getMensagem()).append("%' ");
          }
     ...
     */
    protected void singleQuery(Connection conn, PreparedStatement stmt, Mensagem valueObject) 
          throws NotFoundException, SQLException {
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setMensagem(result.getString("mensagem")); 
                    ...
                    //System.out.println("Mensagem Object Not Found!");
                    throw new NotFoundException("Mensagem Object Not Found!");
              }
          } finally {
              if (result != null)
                  result.close();
    ...
    protected List listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
          ...
          try {
              ...
              while (result.next()) {
                   Mensagem temp = createValueObject();
