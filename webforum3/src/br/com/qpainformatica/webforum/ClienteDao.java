...
import java.math.*;
  ...
  * permanently store and retrieve Cliente object instances. 
  */
...
public class ClienteDao {
    ...
    public void load(Connection conn, Cliente valueObject) throws NotFoundException, SQLException {
          ...
          String sql = "SELECT * FROM forum_cliente WHERE (id = ? ) "; 
    ...
    public List loadAll(Connection conn) throws SQLException {
          ...
          String sql = "SELECT * FROM forum_cliente ORDER BY id ASC ";
          List searchResults = listQuery(conn, conn.prepareStatement(sql));

          return searchResults;
    }

    public List loadAllFromId(Connection conn, String id) throws SQLException {

        String sql = "SELECT * FROM forum_cliente WHERE id > ? ORDER BY id ASC ";
    ...
    public synchronized void create(Connection conn, Cliente valueObject) throws SQLException {
          ...
          try {
               sql = "INSERT INTO forum_cliente ( nome, cpf, telefone, "
               + "email) VALUES (?, ?, ?, ?) ";
               stmt = conn.prepareStatement(sql);

               stmt.setString(1, valueObject.getNome()); 
               stmt.setString(2, valueObject.getCpf()); 
               stmt.setString(3, valueObject.getTelefone()); 
    ...
    public void save(Connection conn, Cliente valueObject) 
          ...
          String sql = "UPDATE forum_cliente SET nome = ?, cpf = ?, telefone = ?, "
               + "email = ? WHERE (id = ? ) ";
          PreparedStatement stmt = null;
    ...
    public void delete(Connection conn, Cliente valueObject) 
          ...
          String sql = "DELETE FROM forum_cliente WHERE (id = ? ) ";
          PreparedStatement stmt = null;
    ...
    public void deleteAll(Connection conn) throws SQLException {
          ...
          String sql = "DELETE FROM forum_cliente";
          PreparedStatement stmt = null;
    ...
    public int countAll(Connection conn) throws SQLException {
          ...
          String sql = "SELECT count(*) FROM forum_cliente";
          PreparedStatement stmt = null;
          ResultSet result = null;
          int allRows = 0;
    ...
    public List searchMatching(Connection conn, Cliente valueObject) throws SQLException {
          ...
          boolean first = true;
          StringBuffer sql = new StringBuffer("SELECT * FROM forum_cliente WHERE 1=1 ");
