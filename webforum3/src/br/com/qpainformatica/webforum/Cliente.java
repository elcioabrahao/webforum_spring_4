...
import java.math.*;
  ...
  * This class is value object representing database table forum_cliente
...
public class Cliente implements Cloneable, Serializable {
    ...
    public boolean hasEqualMapping(Cliente valueObject) {
          ...
          if (this.cpf == null) {
                    if (valueObject.getCpf() != null)
                           return(false);
          } else if (!this.cpf.equals(valueObject.getCpf())) {
                    return(false);
          }
          if (this.telefone == null) {
                    if (valueObject.getTelefone() != null)
                           return(false);
          } else if (!this.telefone.equals(valueObject.getTelefone())) {
                    return(false);
          }
          if (this.email == null) {
    ...
    public String toString() {
        ...
        out.append("\nclass Cliente, mapping to table forum_cliente\n");
        out.append("Persistent attributes: \n"); 
        out.append("id = " + this.id + "\n"); 
        out.append("nome = " + this.nome + "\n"); 
        out.append("cpf = " + this.cpf + "\n"); 
    ...
    public Object clone() {
        ...
        if (this.cpf != null)
             cloned.setCpf(new String(this.cpf)); 
        if (this.telefone != null)
             cloned.setTelefone(new String(this.telefone)); 
        if (this.email != null)
